...
export const wildlifeSpecies: WildlifeSpecies[] = [
  {
    ...
    category: "mammal",
    description:
      "Coyotes have returned to Golden Gate Park and the Presidio since 2002. These adaptable predators are most active during dawn and dusk hours.",
    image: "/images/coyote.jpg",
    imageAttribution: {
      url: "https://unsplash.com/photos/animal-standing-on-grass-during-day-drl_EYmkujk",
      source: "unsplash.com",
      attribution: "Dylan Ferreira",
    },
    location: {
      lat: 37.7703,
      lng: -122.4751,
  ...
  },
  {
    ...
    category: "flower",
    description:
      "California's state flower blooms in vibrant orange across Golden Gate Park's meadows and hillsides.",
    image: "/images/california_poppy.jpg",
    imageAttribution: {
      url: "https://unsplash.com/photos/a-field-of-orange-flowers-next-to-a-body-of-water-o-z4NgTi4HA",
      source: "unsplash.com",
      attribution: "Arun Antony",
    },
    location: {
      lat: 37.7691,
      lng: -122.4583,
    ...
    seasonality: {
      ...
      behavior:
        "Peak blooming in spring, flowers close at night and on cloudy days",
    },
  ...
  },
  {
    ...
    category: "bird",
    description:
      "Large raptors frequently seen soaring over Golden Gate Park, hunting for small mammals and birds.",
    image: "/images/red_tailed_hawk.jpg",
    imageAttribution: {
      url: "https://unsplash.com/photos/brown-and-white-bird-on-tree-branch-during-daytime-7DlEYVs-a58",
      source: "unsplash.com",
      attribution: "Patrice Bouchard",
    },
    location: {
      lat: 37.7715,
      lng: -122.469,
  ...
  },
  {
    ...
    category: "tree",
    description:
      "Iconic California native oak trees that provide habitat for numerous wildlife species.",
    image: "/images/coast_oak.jpg",
    imageAttribution: {
      url: "https://unsplash.com/photos/a-tree-with-many-branches-0tb17C9MTH8",
      source: "unsplash.com",
      attribution: "Jarrod Davies",
    },
    location: {
      lat: 37.7698,
      lng: -122.4612,
  ...
  },
  {
    ...
    category: "bird",
    description:
      "Intelligent blue birds known for their problem-solving abilities and acorn caching behavior.",
    image: "/images/blue_jay.jpg",
    imageAttribution: {
      url: "https://unsplash.com/photos/a-blue-and-white-bird-sitting-on-top-of-a-tree-branch-Wb1UZIxb9DY",
      source: "unsplash.com",
      attribution: "Greg Sellentin",
    },
    location: {
      lat: 37.7685,
      lng: -122.4645,
    ...
    seasonality: {
      ...
      behavior:
        "Very active during acorn season (fall), highly social year-round",
    },
  ...
  },
  {
    ...
    category: "flower",
    description:
      "Native California wildflower with striking blue-purple blooms in spring.",
